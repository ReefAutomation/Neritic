...
private:
    ...
    // Actually led_strip_handle_t, kept opaque to avoid exposing component headers
    void *_strip;

    // Mutex for thread safety
    void *_mutex; // Actually a SemaphoreHandle_t, but avoid including FreeRTOS in header
};
